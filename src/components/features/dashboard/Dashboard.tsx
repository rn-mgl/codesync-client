...
import { ProblemList } from "@/src/interfaces/problem.interface";
  ...
  React.useEffect(() => {
    const fetchDashboard = async () => {
      try {
        ...
        const resolve: GetDashboardResponse = await response.json();
          ...
          <>
            <div className="grid grid-cols-1 t:grid-cols-2 l-s:grid-cols-3 gap-4 w-full">
              ...
              >
                ...
                <p className="text-lg font-bold">{dashboard.problems_solved}</p>
