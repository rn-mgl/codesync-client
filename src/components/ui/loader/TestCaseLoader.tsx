  ...
  return (
    <div className="flex flex-col items-start justify-start w-full gap-8">
      <div className="w-full flex justify-between">
        <div className="h-4 bg-neutral-300 rounded-sm animate-pulse w-28" />
        ...
        <div className="w-full flex flex-col items-start justify-start gap-4 p-2 border-primary/50 border rounded-b-md t:p-4">
          ...
          {new Array(2).fill(0).map((_, i) => (
            <div
              ...
              className="w-full flex flex-col items-start justify-center gap-1"
            >
              <div className="h-2 bg-neutral-300 rounded-sm animate-pulse w-24" />
              <div className="w-full h-8 bg-neutral-200 border-2 border-neutral-300 rounded-md animate-pulse" />
            </div>
          ))}
          ...
          {new Array(2).fill(0).map((_, i) => (
            <div
              ...
              className="w-full flex flex-col items-start justify-center gap-1"
            >
              <div className="h-2 bg-neutral-300 rounded-sm animate-pulse w-28" />
              <div className="w-14 h-8 bg-neutral-200 border-2 border-neutral-300 rounded-md animate-pulse" />
            </div>
          ))}
        </div>
      </div>
